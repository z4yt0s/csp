...
class StartCSP:
    ...
    Attributes:
        ...
        PROMPT_STYLE (ClassVar[Style]): Representing the style of the 
    ...
    PROMPT_STYLE: ClassVar[Style] = Style.from_dict({'msg': '#227547 bold'})
    ...
    def _set_masterkey(self) -> None:
        ...
        """
        first_text: str = '''
            [*] The first time CSP is run, you must provide a master
            key, then you will have to type the master key twice to
            verify it.
        '''
        self.vs.print(first_text, style='inf')
        while True:
        ...
        self.data_mgmt.cursor.execute(query)
        self.vs.print('Masterkey inserted correctly', type='info')
